...
*Summary*
If you have GU10 or MR16 halogen bulbs in your house, now is the time to replace them. Read on for advice on which bulbs to get and where to get them from.
...
But many existing transformers will not work with low-power LED bulbs. This means that&mdash;unless you have compatible transformers&mdash;there will be three choices for replacing existing halogen MR16 bulbs: choose more expensive LED bulbs capable of working with existing transformers; replace existing transformers with new transformers capable of working at low currents; or remove the transformers altogether and switch to GU10 bulbs.
