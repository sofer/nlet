...
Consider investing in one of the newer "COB" LEDs. They are not much more expensive and the light distribution is generally better than the surface-mounted LEDs used in older models (although your choices may be limited if your existing lights use an incompatible 12V transformer).
