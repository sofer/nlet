...
*Conclusion*
We could have replaced our transformers relatively cheaply, but in the end, decided to have our existing transformers removed and the old GU5.3 sockets replaced with GU10 sockets running straight off the mains (except in the bathroom, where we decided to keep the existing 12V supply for safety reasons).
